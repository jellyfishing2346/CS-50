...
def load_data(data_dir):
    ...
    for category in range(0, NUM_CATEGORIES - 1):  # iterate over all directories
        information = os.path.join(data_dir, str(category))  # determine path to the directory
        for filename in os.listdir(information):  # iterate over all files in the directory
